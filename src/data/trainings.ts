...
export const trainingCategories: TrainingCategory[] = [
  ...
  },
  {
    name: 'NR 5 – CIPA',
    courses: [
      { nr: 'NR 5', title: 'CIPA – Grau de Risco 1', hours: 8, image: 'Treinamento NR 5 – CIPA.png' },
      { nr: 'NR 5', title: 'CIPA – Grau de Risco 2', hours: 12, image: 'Treinamento NR 5 - CIPA Grau de risco 2.png' },
      { nr: 'NR 5', title: 'CIPA – Grau de Risco 3', hours: 16, image: 'Treinamento NR 5 – CIPA 2.png' },
      { nr: 'NR 5', title: 'CIPA – Grau de Risco 4', hours: 20, image: 'Treinamento NR 5 – CIPA 3.png' },
  ...
  },
  {
    ...
    courses: [
      { nr: 'NR 20', title: 'Inflamáveis e Combustíveis – Básico (Classe I)', hours: 6, image: 'Inflamáveis e Combustíveis – Básico (Classe I).jpg' },
  ...
  },
  {
    ...
    courses: [
      ...
      { nr: 'NR 23', title: 'Brigada de Incêndio (Básico)', hours: 14, image: 'NR 23 Brigada de Incendio Básico.jpg' },
      { nr: 'NR 23', title: 'Brigada de Incêndio (Básico – Reciclagem)', hours: 14, image: 'NR 23 Brigada de incendio (Básico - Reciclagem).jpg' },
      { nr: 'NR 23', title: 'Brigada de Incêndio (IT-17)', hours: 6, image: 'BRIGADA DE INCENCIO (IT-17) NR 23.jpg' },
      ...
      { nr: 'NR 23', title: 'Brigada de Incêndio (Intermediário)', hours: 20, image: 'Brigada de Incêncio (Intermediário).jpg' },
      { nr: 'NR 23', title: 'Brigada de Incêndio (Intermediário – Reciclagem)', hours: 20, image: 'Brigada de Incêncio (Intermediário - Reciclagem).jpg' },
